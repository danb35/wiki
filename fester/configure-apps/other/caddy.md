...
* You've installed Dockge, as this guide will be using Dockge to install Caddy.
...
```
Save this file.  You'll also need to create a Docker network; run `docker network create proxy`.
